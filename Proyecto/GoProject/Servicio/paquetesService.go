...
var (
	device         string        = "enp3s0" //me estoy conectando por la interfaz de wifi de mi computadora
...
func main() {
	...
	var filter string = "ether dst dc:4a:3e:16:e8:b3"
	err = handle.SetBPFFilter(filter)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println("Only capturing MAC dst dc:4a:3e:16:e8:b3 packets.")
